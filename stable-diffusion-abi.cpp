...
sd_ctx_t *new_sd_ctx_go(new_sd_ctx_go_params *context_params) {
    if (context_params->show_debug) {
        ...
        LOG_DEBUG("TEST context_params->wType %d to %d", context_params->wType, sd_type_t(context_params->wType));
        LOG_DEBUG("TEST context_params->rng_type %d to %d", context_params->rng_type,
                  rng_type_t(context_params->rng_type));
        LOG_DEBUG("TEST context_params->schedule %d to %d", context_params->schedule,
