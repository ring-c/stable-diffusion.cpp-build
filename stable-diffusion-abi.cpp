...
sd_ctx_t *new_sd_ctx_go(new_sd_ctx_go_params *context_params) {
  ...
  return new_sd_ctx(
      context_params->model_path, "", "", "", context_params->vae_path,
      context_params->taesd_path, context_params->control_net_path,
      context_params->lora_model_dir, context_params->embed_dir,
      context_params->id_embed_dir, context_params->vae_decode_only,
      context_params->vae_tiling, context_params->free_params_immediately,
      context_params->n_threads, sd_type_t(context_params->wType),
